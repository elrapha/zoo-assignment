class Zoo:
    def __init__(self,zoo_name,zoo_location,open_hours=None,zoo_animals_capacity=0,human_capacity=0):
...
class Animal(Zoo):
    def __init__(self,animal_name,animal_type,animal_age,pet_name,animal_description,zoo_name,zoo_location):
...
class Human(Zoo):  
    def __init__(self,human_name,human_age,human_gender,nationality,zoo_name,zoo_location):
        Zoo.__init__(self, zoo_name, zoo_location)

class Worker(Human):
    def __init__(self,name,age,gender,nationality,zoo_name,zoo_location,shift):
        Human.__init__(self,name,age,gender,nationality,zoo_name,zoo_location)
        self.shift=shift
